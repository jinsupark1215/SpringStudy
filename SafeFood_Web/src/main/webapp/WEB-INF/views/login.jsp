...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#findPWBtn").on('click', function(source) {
			$("#form").attr("action", "/member/goFindPW");
			$("#form").submit();
		});
	});
			...
			<form class="form-horizontal" action="#" method="post" id="form">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-10">
						...
						<button type="button" class="btn btn-warning" id="findPWBtn">
							비밀번호 찾기<span class="glyphicon glyphicon-remove" style="margin-left: 15px"></span>
						</button>
					</div>
				</div>
			</form>
