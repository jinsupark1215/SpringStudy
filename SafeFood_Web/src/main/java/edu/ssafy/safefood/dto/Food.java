...
public class Food implements Comparable<Food>{
	...
	public Food(Food food) {
		this.code = food.code;
		this.name = food.name;
		this.supportpereat = food.supportpereat;
		this.calory = food.calory;
		this.carbo = food.carbo;
		this.protein = food.protein;
		this.fat = food.fat;
		this.sugar = food.sugar;
		this.natrium = food.natrium;
		this.chole = food.chole;
		this.fattyacid = food.fattyacid;
		this.transfat = food.transfat;
		this.maker = food.maker;
